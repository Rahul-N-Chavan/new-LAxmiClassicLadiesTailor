...
const collectionData: Record<
  string,
  {
    name: string;
    description: string;
    items: Array<{ name: string; image: string; price: string }>;
  }
> = {
  "top-picks-for-you": {
    name: "Top Picks For You",
    description:
      "Our most popular and bestselling designs curated just for you",
    items: [
      {
  ...
  "punjabi-style": {
    name: "Punjabi Style",
    description:
      "Vibrant traditional Punjabi wear collection featuring bright colors and rich embroidery",
    items: [
      {
  ...
  "velvet-collection": {
    ...
    description:
      "Luxurious velvet designs perfect for winter weddings and special occasions",
    items: [
      {
        name: "Velvet Sharara",
        image:
...
// Handle duplicate/alternative key for safety
collectionData["our-custom-design-gallery"] =
  collectionData["custom-design-gallery"];

// --- 2. STATIC PARAMS GENERATION ---
export function generateStaticParams() {
  return [
    { collection: "seasonal-&-custom", slug: "top-picks-for-you" },
    { collection: "seasonal-&-custom", slug: "punjabi-style" },
    { collection: "seasonal-&-custom", slug: "velvet-collection" },
    { collection: "seasonal-&-custom", slug: "custom-design-gallery" },
    { collection: "seasonal-&-custom", slug: "our-custom-design-gallery" },
  ];
}
...
export default function SubCollectionPage({
  ...
  // Use a different background image for each collection if available, or a default fallback
  const bgImage =
    collection.items[0]?.image ||
    "https://images.pexels.com/photos/3394310/pexels-photo-3394310.jpeg?auto=compress&cs=tinysrgb&w=1920";

  return (
    <>
      <Header />
      <main>
        {/* Updated Header Section matches "About Us" style */}
        ...
        <section className="py-20 bg-luxury-cream">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-luxury-maroon/70 text-lg mb-8 max-w-2xl mx-auto">
              Our expert stylists can customize any of these designs to your
              exact measurements and preferences.
            </p>
            <Link href="/consult">
              <Button className="bg-luxury-gold hover:bg-luxury-gold/90 text-white font-medium px-8 h-12 text-lg">
